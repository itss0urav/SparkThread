    ...
    <Link href='/'>
      <a className={style.wrapper}>
        <div>
          <img
            className='h-8 w-8'
            src='https://media.discordapp.net/attachments/979241917852303370/1025031343333187604/viper_X_me.png?width=818&height=612'  //top reddit left logo
            viewBox='0 0 20 20'
          />
            <g>
        ...
        <div>
          <svg
            ...
            viewBox='0 0 57 18'
            xmlns='http://www.w3.org/2000/svg'  //top left reddit logo in text
          >
            <g fill='#D7DADC'>
